...
<tr>
	...
	<td>
		<img src="<?php print pp_get_album_url($album['album_id']) . '/thumb/' . $album['thumb'] ?>" alt="" />
	</td>
	<td>
	...
	<td>
		<form action="" method="post" class="order_form">
			<input type="hidden" name="task" value="reorder_album" />
	...
	<td>
		...
		<a href="<?php print $cpage; ?>&task=disable_album&album_id=<?php print $album['album_id']; ?>" class="disable album"><?php _e('Disable'); ?></a>&nbsp;
		<?php else: ?>
		<a href="<?php print $cpage; ?>&task=enable_album&album_id=<?php print $album['album_id']; ?>" class="enable album"><?php _e('Enable'); ?></a>&nbsp;
		<?php endif; ?>
		<a class="thickbox" href="<?php print PPLAY_PLUGIN_URL; ?>/html/edit_album.php?album_id=<?php print $album['album_id']; ?>&KeepThis=true&TB_iframe=true&height=400&width=600"><?php _e('Edit'); ?></a>&nbsp;
		<a href="<?php print $cpage; ?>&view=manage_album&album_id=<?php print $album['album_id']; ?>"><?php _e('Manage Images'); ?></a>&nbsp;
		<a href="<?php print $cpage; ?>&task=delete_album&album_id=<?php print $album['album_id']; ?>" class="delete_album"><?php _e('Delete'); ?></a>&nbsp;
	</td>
</tr>
<?php $i++; endforeach; ?>